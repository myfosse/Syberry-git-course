...
VALUES (999, "hotel_owner@mail.ru", '$2a$10$vmGQQWOEvG1kyCRUcIm8xuFyK8OuKdOrzhPe97IKg.fmxmnHa9wXS', "HotelOwner"),
       (1000, "hotel_saver@mail.ru", '$2a$10$vmGQQWOEvG1kyCRUcIm8xuFyK8OuKdOrzhPe97IKg.fmxmnHa9wXS', "HotelSaver");

INSERT INTO pricing (id, type)
VALUES (1, 'ONE_DAY');

INSERT INTO hotels (id, title, location_id, owner_id)
VALUES (1, 'DoubleTree', 1, 999),
       (2, 'Bahía del Duque Resort', 3, 999),
       (3, 'Marriott', 2, 999);
...
INSERT INTO saved_hotels (id, hotel_id, user_id)
VALUES (1, 1, 1000),
       (2, 3, 1000);